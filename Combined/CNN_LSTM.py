...
def crear_modeloFF():
    ...
    #dense1 = Dense(HIDDEN_NEURONS, activation = 'relu')(mxPl1D)
    ...
    output1 = Dense(OUT_NEURONS, name='Dense_1')(drop3)
    ...
    plot_model(model, to_file='CNN_LSTM', show_shapes=True)
    model.summary()
    return model
